...
public class DepositoContaCorrente {
	...
	public void newScreen(int numero) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DepositoContaCorrente window = new DepositoContaCorrente(numero);
	 ...
	 */
	public DepositoContaCorrente(int numeroDaConta) {
...
// *************************************************************************************************************************************************		
		...
		btnDepositar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {			
				...
				if (minhaContaCorrente.verificaLimite(numeroDaConta, valor) == true) {
					minhaContaCorrente.deposita(numeroDaConta, valor);
