...
public class SacaContaCorrente {
	...
	public void newScreen(int numero) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SacaContaCorrente window = new SacaContaCorrente(numero);
	 ...
	 */
	public SacaContaCorrente(int numeroDaConta) {
...
// *************************************************************************************************************************************************		
		...
		btnSacar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {			
				...
				if (minhaContaCorrente.saca(numeroDaConta, valor) == true) {
