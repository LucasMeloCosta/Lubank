...
public class TransferenciaContaPoupanca {
	...
	public void newScreen(int numero) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TransferenciaContaPoupanca window = new TransferenciaContaPoupanca(numero);
	 ...
	 */
	public TransferenciaContaPoupanca(int numeroDaConta) {
...
// *************************************************************************************************************************************************		
		...
		btnTransferir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {			
				...
				}else if (minhaContaPoupanca.transfereCompara(numeroDaConta, contaDestino,valor) == 0){
					JOptionPane.showMessageDialog(null, minhaContaPoupanca.transfereString(numeroDaConta, contaDestino,valor), "Erro", JOptionPane.ERROR_MESSAGE);
					
				}else if (minhaContaPoupanca.transfereCompara(numeroDaConta, contaDestino,valor) == -1) {
					JOptionPane.showMessageDialog(null, minhaContaPoupanca.transfereString(numeroDaConta, contaDestino,valor), "Erro", JOptionPane.ERROR_MESSAGE);
				}else {
					JOptionPane.showMessageDialog(null, minhaContaPoupanca.transfereString(numeroDaConta, contaDestino,valor), "Erro", JOptionPane.ERROR_MESSAGE);
				}
